...
[![Aldi Price Tracker](https://img.shields.io/badge/Aldi%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://brightdata.de/products/insights/price-tracker/aldi)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://brightdata.de/products/insights/price-tracker/aldi)

Aldi-Preisverfolgung in Echtzeit – eine führende deutsche internationale Discount-Einzelhandelskette. Zwei Möglichkeiten für den Einstieg: eine **vollständig verwaltete** Intelligence-Plattform oder ein **benutzerdefinierter Scraper**, erstellt mit dem AI Scraper Builder von Bright Data.

---

## Option 1: Bright Insights - KI-gestützte Preisverfolgung (Empfohlen)

**[Bright Insights](https://brightdata.de/products/insights/price-tracker/aldi)** ist die vollständig verwaltete Retail-Intelligence-Plattform von Bright Data. Keine Scraper zu erstellen, keine Infrastruktur zu warten – nur strukturierte, analysebereite Preisdaten, die an Dashboards, Data Feeds oder Ihre BI-Tools geliefert werden.
...
- ✅ **Verfolgen Sie die Lebensmittelpreisinflation** über Kategorien hinweg bei Aldi
- ✅ **Überwachen Sie Aktionen** und wöchentliche Angebote automatisch
...
> **Ab $250/Monat – [Erhalten Sie ein individuelles Angebot →](https://brightdata.de/products/insights/price-tracker/aldi)**

---

## Option 2: Erstellen Sie Ihren eigenen Aldi-Scraper

Keine vorgefertigte Aldi-Scraper-API? Kein Problem. Der **AI Scraper Builder** von Bright Data generiert mit nur wenigen Klicks einen benutzerdefinierten Aldi-Scraper — ganz ohne Programmierung.

### Erstellen Sie Ihren Aldi-Scraper in wenigen Minuten

**[Öffnen Sie den Aldi AI Scraper Builder →](https://brightdata.de/products/web-scraper/aldi)**
...
- Eine **Web Scraper ID** für Aldi (aus dem obigen Build-Schritt)
...
1. **Klonen Sie dieses repository**
   ...
   ```bash
   git clone https://github.com/bright-data-de/aldi-price-tracker.git
   cd aldi-price-tracker
   ```
...
3. **Konfigurieren Sie Zugangsdaten**
   ...
   > **Ihre Web Scraper ID**
   > Fügen Sie die Web Scraper ID aus Ihrem [AI Scraper Builder dashboard](https://brightdata.de/products/web-scraper/aldi)
...
Sobald Ihr Aldi-Scraper erstellt wurde und Ihre Web Scraper ID in `.env` konfiguriert ist, funktioniert die Python-Schnittstelle auf die gleiche Weise:

### 1. Bestimmte Produkte per URL verfolgen

Übergeben Sie eine Liste von Aldi-Produkt-URLs, um strukturierte Preisdaten abzurufen:

```python
from price_tracker import track_prices

urls = [
    "https://www.aldi.com/products/sample-product",
...
Sammeln Sie alle Produkte von einer Aldi-Kategorieseite:

```python
from price_tracker import discover_by_category

results = discover_by_category(
    "https://aldi.com/category/example",
    limit=100,
)
```
...
[
  {
    "url": "https://www.aldi.com/products/sample-product",
    ...
    "rating": 4.5,
    "reviews_count": 1234,
    "images": ["https://aldi.com/images/product1.jpg"],
...
inputs = [{"url": "https://www.aldi.com/products/sample-product"}]
...
- 🌟 [Aldi Price Tracker - Bright Insights (Managed)](https://brightdata.de/products/insights/price-tracker/aldi)
- 🏗️ [Build a Aldi Scraper](https://brightdata.de/products/web-scraper/aldi)
